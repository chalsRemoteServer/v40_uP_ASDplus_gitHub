...
//unsigned char a[3];
	//getASCIIFromUChar1(phase,&a[0]);
unsigned char *phase=&Deteccion.phase;
unsigned char *phasefrac=&Deteccion.phasefrac;
...
const signed short int xx[]={-90,30,-12,23,-334,31,-313,12,-32,34};
const signed short int yy[]={ 30,-33,12,123,-1134,431,23,12,-32,34};
