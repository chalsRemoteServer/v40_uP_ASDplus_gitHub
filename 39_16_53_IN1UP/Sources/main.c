...
void main(void){  //MCF52233CAF60    256Kbytes/RAM=32kbytes.
  ...
  for(;;){
	    ...
	    Controlador_Driver_Procesador_de_Señales_DDS_Operativo();// se tiene que inizializar el dsp //despliega los puntitos en pantalla DDS
...
//	    Display_DDS_TRANSMISSOR_CONTROLLER();//transmite los datos al menu DDS
	    ...
	    Controlador_Driver_de_Display_Graficos_VFD_Operativo();//displayOperativoBarraDet_Numeros();//deprecated Display&Cntrl de datos del Menu de Configuracion de angulo de Vibracion 
