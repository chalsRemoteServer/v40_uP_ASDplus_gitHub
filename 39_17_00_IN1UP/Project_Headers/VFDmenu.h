...
* "v39.16.50.14"      27-abr-22, revision productos memovirtual, comunicacion IIC operativa, funciones apuntadas,                                
*                                                 
*                               
 ...
 *                       4.-numeros de Sens, Altr, fase, en DDS menu, config, param de prod
 *                              cuando a un digito individual SUMAR|RESTAR el numero a la izquierda
 *                              tambien se sume|reste en su limite  e.g.  0193->sumar digito 3 -> 0203 
 *                                                                          ^
 *                       3.-                                                            
 *                                                                                 
...
#define AUTOMATICO_PROD                       0xD1 //Producto Automatico Aprender
...
#define NOMBRE_PRODUCTO_SIZE                  20U
...
#define POSX_X                     120 //POSICION de la X
...
#define DDS_CENTRO_X               64U  //PPUNTO en pantalla para encontrar el cero en coordenadas x
#define DDS_CENTRO_Y               95U  //PUNTO EN pantalla para encontrar el cero en coordenadas y
...
struct _Productos_{
	union _Bytes5_{
			unsigned char StatusByte;
			struct{
			  unsigned char isProdChange:1;//habra cambio de prodjucto??
			  unsigned char x1:1;
			  unsigned char x2:1;
			  unsigned char x3:1;
			  unsigned char x4:1;
    ...
    struct _Cntr_{
          unsigned char iProduct0;//producto anterior que habia antes de guardar			
	      unsigned char iProduct;//producto actual seleccionado
	      unsigned char frecuenciaSeleccion;//seleccion de frecuencia
...
struct _Param_Det_Menu_{
	unsigned char *indexchar;//indice del char seleccionado del numero actual
	unsigned char *x1;
...
void Control_Automatico_de_Barra_de_Deteccion_IRQ(void);
