...
struct _GLOBAL_CONTEXTO g,*AjustVibr,*DDSpant,*ParamDet,*AutomProd;
struct _GLOBAL_CONTEXTO *AjParamProd,*NewProd,*textProc,*SelProd;
...
//	   Comm_DDS_FIFO(Signal.CentX,Signal.CentY);//Meter datos a lista para transmision
	   ...
	   Control_Automatico_Producto(Signal.Rotx,Signal.Roty);
...
/*resetea las estructuras de los menus 
 *  y reasigna el nuevo apuntado del nuevo menu 
 *  a las varibles de uso por contexto----------*/
void Reset_estructuras_Menu(struct _GLOBAL_CONTEXTO **a){
const unsigned char SIZE=7;
unsigned char i;
struct _GLOBAL_CONTEXTO **p[SIZE]={&ParamDet,&NewProd,&SelProd,//apuntamos a apuntadores
		                        &DDSpant,&AjParamProd,&AjustVibr,
		                        &textProc};
     for(i=0;i<SIZE;i++)
    	 *(p+i)=0;//los apuntadores apuntan a 0
     *a=&g; //apuntamos a la estructura g
}//finReset_estructuras_Menu-------------------------------------
...
BD1:    if(Deteccion.tipo==NORMAL){//NORMAL det is when threshold lines is in horizolt without height lines
     ...
     switch(EstadoBarra){//conversion de bits individuales de boxes a numero de box
       case 0x0001:R=FIFO_displayBox_push(1);//displayBox(1); break;  //0000 0000 0000 0001
       case 0x0003:R=FIFO_displayBox_push(2); break;  //0000 0000 0000 0011
       case 0x0007:R=FIFO_displayBox_push(3); break;  //0000 0000 0000 0111
       case 0x000F:R=FIFO_displayBox_push(4); break;  //0000 0000 0000 1111
       case 0x001F:R=FIFO_displayBox_push(5); break;  //0000 0000 0001 1111
       case 0x003F:R=FIFO_displayBox_push(6); break;  //0000 0000 0011 1111
       case 0x007F:R=FIFO_displayBox_push(7); break;  //0000 0000 0111 1111
       case 0x00FF:R=FIFO_displayBox_push(8); break;  //0000 0000 1111 1111
       case 0x01FF:R=FIFO_displayBox_push(9); break;  //0000 0001 1111 1111
       case 0x03FF:R=FIFO_displayBox_push(10); break;  //0000 0011 1111 1111
       case 0x07FF:R=FIFO_displayBox_push(11); break;  //0000 0111 1111 1111
       case 0x0FFF:R=FIFO_displayBox_push(12); break;  //0000 1111 1111 1111
       case 0x1FFF:R=FIFO_displayBox_push(13); break;  //0001 1111 1111 1111
       case 0x3FFF:R=FIFO_displayBox_push(14); break;  //0011 1111 1111 1111
       case 0x7FFF:R=FIFO_displayBox_push(15); break;  //0111 1111 1111 1111
       case 0xFFFF:if(EstadoBarraMSB==OFF)
    	   	   	   	    R=FIFO_displayBox_push(16);  //1111 1111 1111 1111
                   else R=FIFO_displayBox_push(17);
                   break;
       case 0x0000:R=FIFO_displayBox_push(0); break;
       default:break;
        }//FIN SWITCH-------------------------------------------
    	//}//fin de WAIT
      // if(R==FALSE)
...
unsigned short int maxx,maxy,ymax,ymin;	
	     ...
	     switch(zoom.Zoom){
			...
			case 1: maxx=ZOOM_MAX_X_01;    maxy=ZOOM_MAX_Y_01;ymax=23919+1;ymin=369; break;                                 
			case 2: maxx=ZOOM_MAX_X_02;    maxy=ZOOM_MAX_Y_02;ymax=2649+1;ymin=81; break;                                 
			case 3: maxx=ZOOM_MAX_X_03;    maxy=ZOOM_MAX_Y_03;ymax=1407+1;ymin=43; break;                                 
			case 4: maxx=ZOOM_MAX_X_04;    maxy=ZOOM_MAX_Y_04;ymax=956+1;ymin=29;break;                                 
			case 5: maxx=ZOOM_MAX_X_05;    maxy=ZOOM_MAX_Y_05;ymax=724+1;ymin=22; break;                                 
			case 6: maxx=ZOOM_MAX_X_06;    maxy=ZOOM_MAX_Y_06;ymax=583+1;ymin=17; break;                                 
			case 7: maxx=ZOOM_MAX_X_07;    maxy=ZOOM_MAX_Y_07;ymax=488+1;ymin=15; break;                                 
			case 8: maxx=ZOOM_MAX_X_08;    maxy=ZOOM_MAX_Y_08;ymax=419+1;ymin=12; break;                                 
			case 9: maxx=ZOOM_MAX_X_09;    maxy=ZOOM_MAX_Y_09;ymax=367+1;ymin=11; break;                                 
			case 10:maxx=ZOOM_MAX_X_10;    maxy=ZOOM_MAX_Y_10;ymax=327+1;ymin=10; break;                                
			case 11:maxx=ZOOM_MAX_X_11;    maxy=ZOOM_MAX_Y_11;ymax=295+1;ymin=9; break;                                
			case 12:maxx=ZOOM_MAX_X_12;    maxy=ZOOM_MAX_Y_12;ymax=268+1;ymin=8; break;                                
			case 13:maxx=ZOOM_MAX_X_13;    maxy=ZOOM_MAX_Y_13;ymax=246+1;ymin=7; break;                                
			case 14:maxx=ZOOM_MAX_X_14;    maxy=ZOOM_MAX_Y_14;ymax=227+1;ymin=7; break;                                
			case 15:maxx=ZOOM_MAX_X_15;    maxy=ZOOM_MAX_Y_15;ymax=211+1;ymin=6; break;                                
			case 16:maxx=ZOOM_MAX_X_16;    maxy=ZOOM_MAX_Y_16;ymax=197+1;ymin=6; break;                                
			case 17:maxx=ZOOM_MAX_X_17;    maxy=ZOOM_MAX_Y_17;ymax=185+1;ymin=5; break;                                
			case 18:maxx=ZOOM_MAX_X_18;    maxy=ZOOM_MAX_Y_18;ymax=174+1;ymin=5; break;                                
			case 19:maxx=ZOOM_MAX_X_19;    maxy=ZOOM_MAX_Y_19;ymax=164+1;ymin=5; break;                                
			case 20:maxx=ZOOM_MAX_X_20;    maxy=ZOOM_MAX_Y_20;ymax=156+1;ymin=4; break;                                
			case 21:maxx=ZOOM_MAX_X_21;    maxy=ZOOM_MAX_Y_21;ymax=148+1;ymin=4; break;                                
			case 22:maxx=ZOOM_MAX_X_22;    maxy=ZOOM_MAX_Y_22;ymax=141+1;ymin=4; break;                                
			case 23:maxx=ZOOM_MAX_X_23;    maxy=ZOOM_MAX_Y_23;ymax=135+1;ymin=4; break;                                
			case 24:maxx=ZOOM_MAX_X_24;    maxy=ZOOM_MAX_Y_24;ymax=129+1;ymin=3; break;                                
			case 25:maxx=ZOOM_MAX_X_25;    maxy=ZOOM_MAX_Y_25;ymax=123+1;ymin=3; break;                                 
			case 26:maxx=ZOOM_MAX_X_26;    maxy=ZOOM_MAX_Y_26;ymax=119+1;ymin=3; break; 
			case 27:maxx=ZOOM_MAX_X_27;    maxy=ZOOM_MAX_Y_27;ymax=114+1;ymin=3; break; 
			case 28:maxx=ZOOM_MAX_X_28;    maxy=ZOOM_MAX_Y_28;ymax=110+1;ymin=3; break; 
			case 29:maxx=ZOOM_MAX_X_29;    maxy=ZOOM_MAX_Y_29;ymax=106+1;ymin=3; break; 
			case 30:maxx=ZOOM_MAX_X_30;    maxy=ZOOM_MAX_Y_30;ymax=102+1;ymin=3; break; 
			case 31:maxx=ZOOM_MAX_X_31;    maxy=ZOOM_MAX_Y_31;ymax=99+1;ymin=3; break; 
			case 32:maxx=ZOOM_MAX_X_32;    maxy=ZOOM_MAX_Y_32;ymax=96+1;ymin=2; break; 
			case 33:maxx=ZOOM_MAX_X_33;    maxy=ZOOM_MAX_Y_33;ymax=93+1;ymin=2; break; 
			case 34:maxx=ZOOM_MAX_X_34;    maxy=ZOOM_MAX_Y_34;ymax=89+1;ymin=2; break; 
			case 35:maxx=ZOOM_MAX_X_35;    maxy=ZOOM_MAX_Y_35;ymax=87+1;ymin=2; break; 
			case 36:maxx=ZOOM_MAX_X_36;    maxy=ZOOM_MAX_Y_36;ymax=85+1;ymin=2; break; 
			case 37:maxx=ZOOM_MAX_X_37;    maxy=ZOOM_MAX_Y_37;ymax=82+1;ymin=2; break; 
			case 38:maxx=ZOOM_MAX_X_38;    maxy=ZOOM_MAX_Y_38;ymax=80+1;ymin=2; break; 
			case 39:maxx=ZOOM_MAX_X_39;    maxy=ZOOM_MAX_Y_39;ymax=78+1;ymin=2; break; 
			case 40:maxx=ZOOM_MAX_X_40;    maxy=ZOOM_MAX_Y_40;ymax=77;ymin=2; break; 
			case 41:maxx=ZOOM_MAX_X_41;    maxy=ZOOM_MAX_Y_41;ymax=74+1;ymin=2;  break; 
			case 42:maxx=ZOOM_MAX_X_42;    maxy=ZOOM_MAX_Y_42;ymax=72+1;ymin=2;  break; 
			case 43:maxx=ZOOM_MAX_X_43;    maxy=ZOOM_MAX_Y_43;ymax=70+1;ymin=2;  break; 
			case 44:maxx=ZOOM_MAX_X_44;    maxy=ZOOM_MAX_Y_44;ymax=69+1;ymin=2;  break; 
			case 45:maxx=ZOOM_MAX_X_45;    maxy=ZOOM_MAX_Y_45;ymax=67+1;ymin=2;  break; 
			case 46:maxx=ZOOM_MAX_X_46;    maxy=ZOOM_MAX_Y_46;ymax=66+1;ymin=2;  break; 
			case 47:maxx=ZOOM_MAX_X_47;    maxy=ZOOM_MAX_Y_47;ymax=64+1;ymin=1;  break; 
			case 48:maxx=ZOOM_MAX_X_48;    maxy=ZOOM_MAX_Y_48;ymax=63+1;ymin=1;  break; 
			case 49:maxx=ZOOM_MAX_X_49;    maxy=ZOOM_MAX_Y_49;ymax=61+1;ymin=1;  break; 
			case 50:maxx=ZOOM_MAX_X_50;    maxy=ZOOM_MAX_Y_50;ymax=60+1;ymin=1;  break; 
			case 51:maxx=ZOOM_MAX_X_51;    maxy=ZOOM_MAX_Y_51;ymax=59+1;ymin=1;  break; 
			case 52:maxx=ZOOM_MAX_X_52;    maxy=ZOOM_MAX_Y_52;ymax=58+1;ymin=1;  break; 
			case 53:maxx=ZOOM_MAX_X_53;    maxy=ZOOM_MAX_Y_53;ymax=57+1;ymin=1;  break; 
			case 54:maxx=ZOOM_MAX_X_54;    maxy=ZOOM_MAX_Y_54;ymax=56+1;ymin=1;  break; 
			case 55:maxx=ZOOM_MAX_X_55;    maxy=ZOOM_MAX_Y_55;ymax=55+1;ymin=1;  break;                                  
			case 56:maxx=ZOOM_MAX_X_56;    maxy=ZOOM_MAX_Y_56;ymax=54+1;ymin=1;  break;                                  
			case 57:maxx=ZOOM_MAX_X_57;    maxy=ZOOM_MAX_Y_57;ymax=53+1;ymin=1;  break;                                  
			case 58:maxx=ZOOM_MAX_X_58;    maxy=ZOOM_MAX_Y_58;ymax=52+1;ymin=1;  break;                                   
			case 59:maxx=ZOOM_MAX_X_59;    maxy=ZOOM_MAX_Y_59;ymax=51+1;;ymin=1;  break;                                   
			case 60:maxx=ZOOM_MAX_X_60;    maxy=ZOOM_MAX_Y_60;ymax=50+1;;ymin=1;  break;                                   
			case 61:maxx=ZOOM_MAX_X_61;    maxy=ZOOM_MAX_Y_61;ymax=49+1;;ymin=1;  break;                                   
			case 62:maxx=ZOOM_MAX_X_62;    maxy=ZOOM_MAX_Y_62;ymax=48+1;;ymin=1; break;                                    
			case 63:maxx=ZOOM_MAX_X_63;    maxy=ZOOM_MAX_Y_63;ymax=48+1;;ymin=1; break;                                   
			case 64:maxx=ZOOM_MAX_X_64;    maxy=ZOOM_MAX_Y_64;ymax=47+1;;ymin=1; break;                                   
			case 65:maxx=ZOOM_MAX_X_65;    maxy=ZOOM_MAX_Y_65;ymax=46+1;;ymin=1; break;                                  
			case 66:maxx=ZOOM_MAX_X_66;    maxy=ZOOM_MAX_Y_66;ymax=45+1;;ymin=1; break;                                   
			case 67:maxx=ZOOM_MAX_X_67;    maxy=ZOOM_MAX_Y_67;ymax=45+1;;ymin=1; break;                                    
			case 68:maxx=ZOOM_MAX_X_68;    maxy=ZOOM_MAX_Y_68;ymax=44+1;;ymin=1; break;                                     
			case 69:maxx=ZOOM_MAX_X_69;    maxy=ZOOM_MAX_Y_69;ymax=43+1;;ymin=1; break;                                     
			case 70:maxx=ZOOM_MAX_X_70;    maxy=ZOOM_MAX_Y_70;ymax=43+1;;ymin=1; break;                                    
			case 71:maxx=ZOOM_MAX_X_71;    maxy=ZOOM_MAX_Y_71;ymax=42+1;ymin=1; break;                                    
			case 72:maxx=ZOOM_MAX_X_72;    maxy=ZOOM_MAX_Y_72;ymax=42+1;ymin=1; break;                                    
			case 73:maxx=ZOOM_MAX_X_73;    maxy=ZOOM_MAX_Y_73;ymax=41+1;ymin=1; break;                                     
			case 74:maxx=ZOOM_MAX_X_74;    maxy=ZOOM_MAX_Y_74;ymax=40+1;ymin=1; break;                                     
			case 75:maxx=ZOOM_MAX_X_75;    maxy=ZOOM_MAX_Y_75;ymax=40+1;ymin=1; break;                                    
			case 76:maxx=ZOOM_MAX_X_76;    maxy=ZOOM_MAX_Y_76;ymax=40;ymin=1; break;                                     
			case 77:maxx=ZOOM_MAX_X_77;    maxy=ZOOM_MAX_Y_77;ymax=40;ymin=1; break;                                     
			case 78:maxx=ZOOM_MAX_X_78;    maxy=ZOOM_MAX_Y_78;ymax=39;ymin=1; break;                                    
			case 79:maxx=ZOOM_MAX_X_79;    maxy=ZOOM_MAX_Y_79;ymax=39;ymin=1; break;
			case 80:maxx=ZOOM_MAX_X_80;    maxy=ZOOM_MAX_Y_80;ymax=38;ymin=1; break;                                    
			case 81:maxx=ZOOM_MAX_X_81;    maxy=ZOOM_MAX_Y_81;ymax=38;ymin=1; break;                                    
			case 82:maxx=ZOOM_MAX_X_82;    maxy=ZOOM_MAX_Y_82;ymax=37;ymin=1; break;
			case 83:maxx=ZOOM_MAX_X_83;    maxy=ZOOM_MAX_Y_83;ymax=37;ymin=1; break;                                    
			case 84:maxx=ZOOM_MAX_X_84;    maxy=ZOOM_MAX_Y_84;ymax=35;ymin=1; break;                                    
			case 85:maxx=ZOOM_MAX_X_85;    maxy=ZOOM_MAX_Y_85;ymax=36;ymin=1; break;
			case 86:maxx=ZOOM_MAX_X_86;    maxy=ZOOM_MAX_Y_86;ymax=36;ymin=1; break;                                   			                                  
			case 87:maxx=ZOOM_MAX_X_87;    maxy=ZOOM_MAX_Y_87;ymax=35;ymin=1; break;
			case 88:maxx=ZOOM_MAX_X_88;    maxy=ZOOM_MAX_Y_88;ymax=35;ymin=1; break;
			case 89:maxx=ZOOM_MAX_X_89;    maxy=ZOOM_MAX_Y_89;ymax=34;ymin=2; break;
			
			case 90:maxx=ZOOM_MAX_X_90;    maxy=ZOOM_MAX_Y_90;ymax=34;ymin=2; break;  			
			case 91:maxx=ZOOM_MAX_X_91;    maxy=ZOOM_MAX_Y_91;ymax=34;ymin=2; break;                                    
			case 92:maxx=ZOOM_MAX_X_92;    maxy=ZOOM_MAX_Y_92;ymax=33;ymin=2;  break;                                     
			case 93:maxx=ZOOM_MAX_X_93;    maxy=ZOOM_MAX_Y_93;ymax=33;ymin=2;  break;
			case 94:maxx=ZOOM_MAX_X_94;    maxy=ZOOM_MAX_Y_94;ymax=33;ymin=2;  break;	
			case 95:maxx=ZOOM_MAX_X_95;    maxy=ZOOM_MAX_Y_95;ymax=32;ymin=2;  break;   
			case 96:maxx=ZOOM_MAX_X_96;    maxy=ZOOM_MAX_Y_96;ymax=32;ymin=2;  break;                                       
			case 97:maxx=ZOOM_MAX_X_97;    maxy=ZOOM_MAX_Y_97;ymax=32;ymin=2;  break;                                        
