...
l9:  if(numero[i]==0){
	       ...
	       goto l9;}
    	        ...
    	        vfd.f.append(pos,POSY12,_POS_);// FIFO_displayBoxChar_push(pos,POSY12);
lA:    	        vfd.f.append(numero[i]+0x30,0,_CHAR_);  //_POS_ FIFO_displayBoxChar_push(numero[i]+0x30,0xFE);
    	        if(i==(SIZE1-1))
    	        	return;
    	        i++;
    	        goto lA;}
