...
*  "v39.16.52.0"      27-sept-22 recuperamos mucha informacion perdida de las potencias mclauring y del control de errores
...
struct _Menu_{
	...
	struct _VARS_{
		unsigned char status;//estatus del menu, barra y DDS y graficacion
	}v;
};
