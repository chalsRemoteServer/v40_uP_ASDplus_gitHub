...
#define MTX         0x10U //xxx1 xxxx (0:Receive, 1:Transmit)MASTER_MODE
...
struct I2Cst{//estructura de apuntadores a funciones Ã³ digamos... una clase
	 void (*stop)(void); 
	 void (*enableInt)(void);
	 void (*disableInt)(void);
	 unsigned char  (*interrptI2C)(void);
	 void (*clearInt)(void);
...
//   byte (*start)(void);//funcion start de I2C
...
unsigned char isAknowledge(void);
...
unsigned char init_I2C(unsigned char *inst);
void I2Cenable_int(void);
void I2C_DISable_int(void);
void clear_Flag_INT_I2C(void);
unsigned char get_ACK_I2C(void);
unsigned char get_I2C_get_int(void);
void IIC_stop(void);
