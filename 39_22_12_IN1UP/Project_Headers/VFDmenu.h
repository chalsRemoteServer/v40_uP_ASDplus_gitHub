...
#define VERSION2 "v39.25.0.25"   //branch:feature24_new_nextPID
...
*   "v39.22.12.38"     12-Ene-24  mejoramos el manejo de recursos y el menu DDS en zoom con enter  y grafica señal en DDS y hace cambio de zoom
...
*   "v39.24.1.71"      21-mar.24   el sistema operativo pierde procesos, vamos a cambiar el next_pid, los recursos funcioan bien, vamos a poner
*                                  processos por prioridad, ya enciende display con SO. todavia no esta terminado el sistema de archivos.
*   
*                    
*                                  
