...
void Encender_Todos_Los_Leds(void);
unsigned char buscar_timer_No_asignado(unsigned char pid);
void Monitor_Led3_SignalProcess(unsigned char *inst);
void Monitor_Led4_Sys_Mon(unsigned char *inst);
void Monitor_Led56_Met_Err(unsigned char *inst);
void errorCritico(void);
