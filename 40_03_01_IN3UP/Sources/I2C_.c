...
//extern const unsigned short int SIZE_EEPROM=2000;
extern unsigned char EEPROM_1Mb[SIZE_EEPROM];	
...
unsigned char *getCalendarRTC(unsigned char *n){//GET CALENDAR-NVRAM from RTC-- return pointer to array
...
//Dword add;   funcion deprecated
      //if(I2C.sem!=VERDE)
        //  delay_ms(100);  //esperamos que acabe de recibir para  el dato
      //if(I2C.sem==VERDE){ 
